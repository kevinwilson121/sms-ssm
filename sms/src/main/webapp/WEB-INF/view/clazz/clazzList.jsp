        ...
        $(function () {
            ...
            $('#dataList').datagrid({
                ...
                columns: [[
                    ...
                    {field: 'name', title: '球队名称', width: 150},
                    {field: 'number', title: '球队人数', width: 100},
                    {field: 'coordinator', title: '主教练姓名', width: 150},
                    {field: 'email', title: '主教练邮箱', width: 150},
                    {field: 'telephone', title: '主教练联系方式', width: 150},
                    {field: 'grade_name', title: '所属联赛', width: 150},
                    {field: 'introducation', title: '球队介绍', width: 220}
                ]],
                toolbar: "#toolbar"//工具栏
            });
            ...
            $("#delete").click(function () {
                ...
                if (selectLength === 0) {
                    ...
                    $.messager.confirm("消息提醒", "删除后将无法恢复该球队信息! 确定继续?", function (r) {
                        if (r) {
                            $.ajax({
                                type: "post",
            ...
            //球队与联赛名称搜索按钮的监听事件(将搜索值返回给Controller)
            $("#search-btn").click(function () {
                $('#dataList').datagrid('load', {
                    clazzname: $('#search-clazzname').val(),//获取球队名称
                    gradename: $('#search-gradename').combobox('getValue')//获取联赛名称
                });
            });
...
<div id="toolbar">
    ...
    <div style="margin-left: 10px;">
        ...
        <a href="javascript:" class="easyui-linkbutton"
           data-options="iconCls:'icon-grade',plain:true">联赛名称</a>
        ...
        <!-- 球队名称搜索框 -->
        <a href="javascript:" class="easyui-linkbutton"
           data-options="iconCls:'icon-class',plain:true">球队名称</a>
        ...
        <table id="addTable" style="border-collapse:separate; border-spacing:0 3px;" cellpadding="6">
            <tr>
                ...
                <td colspan="1">
                    <input id="add_name" style="width: 200px; height: 30px;" class="easyui-textbox"
                           type="text" name="name" data-options="required:true, missingMessage:'请选择所属联赛哟~'"/>
                </td>
            </tr>
            <tr>
                <td>球队人数</td>
                <td colspan="1">
                    <input id="add_number" style="width: 200px; height: 30px;" class="easyui-textbox"
                           ...
                           data-options="required:true, missingMessage:'请填写球队人数哟~'"/>
                </td>
            </tr>
            <tr>
                <td>主教练</td>
                <td colspan="1"><input id="add_coordinator" style="width: 200px; height: 30px;" class="easyui-textbox"
                                       ...
                                       data-options="required:true, missingMessage:'请填写主教练姓名哟~'"/>
                </td>
            </tr>
            <tr>
                <td>主教练邮箱</td>
            ...
            <tr>
                ...
                <td colspan="4"><input id="add_introduation" style="width: 200px; height: 60px;" class="easyui-textbox"
                                       ...
                                       data-options="multiline:true,required:true, missingMessage:'球队介绍不能为空呦~'"/>
                </td>
            </tr>
        </table>
    </form>
