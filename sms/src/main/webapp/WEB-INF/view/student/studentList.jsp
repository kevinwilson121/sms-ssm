        ...
        $(function () {
            ...
            $('#dataList').datagrid({
                ...
                columns: [[
                    ...
                    {field: 'clazz_name', title: '球队', width: 150},
                    {field: 'name', title: '姓名', width: 150},
                    {field: 'sno', title: '球员编号', width: 150},
                    {field: 'gender', title: '性别', width: 50},
                    {field: 'email', title: '邮箱', width: 150},
                    {field: 'telephone', title: '工作电话', width: 150},
                    {field: 'address', title: '国家', width: 150},
...
<div id="toolbar">
    ...
    <div style="margin-left: 10px;">
        ...
        <!-- 球员姓名搜索框 -->
        <a href="javascript:" class="easyui-linkbutton"
           data-options="iconCls:'icon-user-student',plain:true">球员名称</a>
        ...
        <table id="addTable" style="border-collapse:separate; border-spacing:0 3px;" cellpadding="6">
            ...
            <tr>
                ...
                <td colspan="1">
                    <select id="add_clazz_name" style="width: 200px; height: 30px;" class="easyui-combobox"
                            name="clazz_name" data-options="required:true, missingMessage:'请选择所属球队哟~'">
                        <c:forEach items="${clazzList}" var="clazz">
                            <option value="${clazz.name}">${clazz.name}</option>
                        </c:forEach>
                    </select>
            ...
            <tr>
                ...
                <td colspan="1">
                    <input id="add_sno" style="width: 200px; height: 30px;" class="easyui-textbox"
                           type="text" name="sno" data-options="required:true, missingMessage:'请填写球员编号哟~'"/>
                </td>
            </tr>
            <tr>
                <td>密码</td>
            ...
            <tr>
                ...
                <td colspan="1"><input id="add_address" style="width: 200px; height: 30px;" class="easyui-textbox"
                                       ...
                                       data-options="required:true, missingMessage:'请填写国家哟~'"/>
                </td>
            </tr>
            <tr>
                <td>简介</td>
        ...
        <table id="editTable" style="border-collapse:separate; border-spacing:0 3px;" cellpadding="6">
            ...
            <tr>
                ...
                <td colspan="4"><input id="edit_telephone" style="width: 200px; height: 30px;" class="easyui-textbox"
                                       type="text" name="telephone" validType="mobile"
                                       data-options="required:true, missingMessage:'请填写工作电话哟~'"/>
                </td>
            </tr>
            <tr>
                <td>国家</td>
