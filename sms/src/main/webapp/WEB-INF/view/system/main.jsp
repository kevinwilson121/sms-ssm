    ...
    <script type="text/javascript">
        ...
        var _menus = {
            "menus": [
                ...
                <%-- 通过JSTL设置用户查看权限: 仅管理员和主教练可以查看主教练列表信息 --%>
                ...
                <%-- 通过JSTL设置用户查看权限:  仅管理员可以查看球队,联赛,管理员列表信息 --%>
...
<div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="float:right; padding-right:20px;" class="head">
        	<span style="color:blue;" class="easyui-linkbutton" data-options="iconCls:'icon-user',plain:true">
        		...
        		<c:choose>
                    ...
                    <c:when test="${userType==2 }">用户 : </c:when>
                    <c:when test="${userType==3}">游客 : </c:when>
                </c:choose>
        	</span>
            <%-- 从Session中获取登录用户的用户名	--%>
    ...
    <span style="padding-left:10px; font-size: 20px; color:darkgrey;font-weight: bold">球员管理系统</span>
</div>
